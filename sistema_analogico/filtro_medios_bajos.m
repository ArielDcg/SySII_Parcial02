function [b, a, fc, tipo_filtro, N, H_freq] = filtro_medios_bajos()
%FILTRO_MEDIOS_BAJOS Diseña filtro pasabanda Butterworth para medios bajos (512 Hz)
%   Salidas:
%       b, a: Coeficientes del filtro H(s)
%       fc: Frecuencia central (512 Hz)
