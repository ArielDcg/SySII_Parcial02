...
%
% Este Live Script diseña un filtro Butterworth pasabanda analógico para
% la frecuencia de 2.56kHz usando las especificaciones del parcial.
...
% geométrica* de las frecuencias centrales adyacentes según el enunciado.
%
% $$f_{límite} = \sqrt{f_1 \times f_2}$$
...
% $$\omega_o = \sqrt{\omega_1 \times \omega_2}$$
Wo = sqrt(w1*w2);  % rad/s
...
% # Las frecuencias de corte Wc calculadas por buttord() son las que garantizan
%   el cumplimiento de las especificaciones
% # Este filtro se usará en el ecualizador de 4 bandas para la frecuencia de 2.56kHz
